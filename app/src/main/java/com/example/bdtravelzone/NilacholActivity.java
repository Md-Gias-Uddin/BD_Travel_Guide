...
public class NilacholActivity extends AppCompatActivity {
    private TabLayout tabLayout;
    private TextView textView;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nilachol);
        ...
        viewPager.setAdapter(new NilacholActivity.MyPagerAdapter(getSupportFragmentManager()));
